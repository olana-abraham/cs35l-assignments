...
# =========================== [ADD YOUR TESTS HERE] ===========================
    ...
    def test_button_click2(self):
        '''Check if clicking the bottom-right button second adds an O.'''
        tiles = self.driver.find_elements(By.XPATH, self.BOARD_TILE_XPATH)
    ...
    def test_win(self):
        '''Check if app prevents additional moves once a player wins'''
        tiles = self.driver.find_elements(By.XPATH, self.BOARD_TILE_XPATH)
        tiles[0].click()
        tiles[1].click()
        tiles[4].click()
    ...
    def test_chorus_lapilli(self):
        '''Check if game is not just tic-tac-toe'''
        tiles = self.driver.find_elements(By.XPATH, self.BOARD_TILE_XPATH)
        tiles[0].click()
        tiles[1].click()
        tiles[2].click()
